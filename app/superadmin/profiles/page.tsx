...
// Super-admin only. Under /superadmin, so middleware gates the route; the backend
  ...
  return (
    <div>
      ...
      <p className="mb-5 text-sm text-[var(--muted)]">
        ...
        <Link href="/superadmin/payments" className="text-[var(--text)] underline hover:text-white">
